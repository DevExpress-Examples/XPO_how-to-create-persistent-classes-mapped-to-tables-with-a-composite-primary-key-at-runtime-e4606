    ...
    Friend Class Program
        Shared Sub Main(ByVal args() As String)
            ...
            Using uow As New UnitOfWork()
                uow.UpdateSchema()
                Dim engineers As IList(Of Object) = CreateObjects(uow, ciEngineer, New String() { "UserID", "PublicName" }, _
                New Object()() { _
                    New Object(){ "U1", "John" }, _
                    New Object(){ "PAUL", "Paul" }, _
                    New Object(){ "XFR", "Fred" } _
                })
                Dim projects As IList(Of Object) = CreateObjects(uow, ciProject, New String() { "ProjectID", "Title", "Description" }, _
                New Object()() { _
                    New Object(){ "P1", "DemoApp", "bla-bla-bla" }, _
                    New Object(){ "P2", "MegaApp", "duh!" }, _
                    New Object(){ "PNEW", "KillerApp", "wow!" } _
                })
                Dim assignments As IList(Of Object) = CreateObjects(uow, ciAssignment, New String() { "Key.Engineer", "Key.Project", "Role", "Rank" }, _
                New Object()() { _
                    New Object(){ engineers(1), projects(0), "Developer", 6 }, _
                    New Object(){ engineers(2), projects(0), "Developer", 8 }, _
                    New Object(){ engineers(0), projects(1), "Leader", 10 }, _
                    New Object(){ engineers(2), projects(1), "Developer", 8 }, _
                    New Object(){ engineers(1), projects(1), "Consultant", 3 }, _
                    New Object(){ engineers(1), projects(2), "Developer", 8 }, _
                    New Object(){ engineers(2), projects(2), "Developer", 7 }, _
                    New Object(){ engineers(0), projects(2), "Tester", 5 } _
                })
                Dim tasks As IList(Of Object) = CreateObjects(uow, ciTask, New String() { "Key.Project", "Key.TaskNo", "Description" }, _
                New Object()() { _
                    New Object(){ projects(0), 1, "Start" }, _
                    New Object(){ projects(0), 2, "Finish" }, _
                    New Object(){ projects(1), 0, "Framework" }, _
                    New Object(){ projects(1), 1, "Feature1" }, _
                    New Object(){ projects(1), 2, "Feature2" }, _
                    New Object(){ projects(1), 3, "Feature3" }, _
                    New Object(){ projects(1), 4, "Feature4" }, _
                    New Object(){ projects(1), 5, "Feature5" }, _
                    New Object(){ projects(1), 6, "Polish" }, _
                    New Object(){ projects(2), 1, "ready" }, _
                    New Object(){ projects(2), 2, "steady" }, _
                    New Object(){ projects(2), 3, "go" } _
                })
                uow.CommitChanges()
            End Using
